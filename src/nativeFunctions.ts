...
const nativeFunctions = [
	{
		...
		args: [
			{ name: 'function' },
			{ name: 'arguments by position' },
			{ name: 'arguments by name' },
		],
	},
	{
		name: '$args',
	...
	},
	{
		name: 'arithmser',
		description:
			'The `arithmser()` function return an arithmetic series, like the `bach.arithmser` object.',
		args: [
	...
	},
	{
		name: 'cartesianprod',
		description:
			'The `cartesianprod()` function returns the cartesian product of the sublists of an llll.',
		args: [{ name: 'llll' }],
	},
	{
		name: 'classify',
		description:
			'The `classify()` function arranges elements into classes, like the `bach.classify` object.',
		args: [
			{ name: 'llll' },
			{
	...
	},
	{
		name: 'comb',
		description:
			'The `comb()` function returns all the k-combinations of an llll for a range of k, like the bach.comb object.',
		args: [
			{ name: 'llll' },
			{ name: 'kstart (default: 0)' },
			{ name: "kend (default: 'none', meaning the whole llll)" },
		],
	},
	{
		name: 'contains',
	...
	},
	{
		name: 'delace',
		description:
			'The `delace()` function deinterlaces an llll into a given number of lllls, like the `bach.delace` object in mono mode.',
		args: [{ name: 'llll' }, { name: 'count (default: 2)' }],
	},
	{
		name: 'depth',
		description:
			'The `depth()` function returns the depth of an llll, like the `bach.depth` object.',
		args: [{ name: 'llll' }],
	},
	{
		name: 'diff',
		description:
			'The `diff()` function returns the set difference of two lllls, like the `bach.diff` object',
		args: [
			{ name: 'llll1' },
			{ name: 'llll2' },
			{
	...
	},
	{
		...
		args: [
			{ name: 'llll' },
			{ name: 'basefreq (default: 440)' },
			{ name: 'basepitch (default: 6900)' },
		],
	},
	{
		name: 'find',
	...
	},
	{
		name: 'flat',
		description:
			'The `flat()` function flattens depth levels of an llll, like the `bach.flat` object.',
		args: [
			{ name: 'llll' },
			{ name: 'depth' },
	...
	},
	{
		name: 'geomser',
		description:
			'The geomser() function return a geomethric series, like the `bach.arithmser` object.',
		args: [
			{ name: "start (default: 'none')" },
			{ name: "end (default: 'none')" },
	...
	},
	{
		name: 'group',
		description:
			'The `group()` function groups elements in sublists according to a regular size pattern, like the `bach.group` object.',
		args: [
			{ name: 'llll' },
			{ name: 'modulos (default: 1)' },
			{ name: 'overlap (default: 0)' },
		],
	},
	{
		name: 'inlet',
	...
	},
	{
		name: 'insert',
		description:
			'The `insert()` function inserts one or more elements in a list according to their positions, like the `bach.insert` object.',
		args: [
			{ name: 'llll' },
	...
	},
	{
		name: 'intersection',
		description:
			'The `intersection()` function returns the intersection of two lllls, like the `bach.intersection` object',
		args: [
			{ name: 'llll1' },
			{ name: 'llll2' },
			{
	...
	},
	{
		name: 'left',
		description:
			'The `left()` function returns the left part of an llll relative to an index.',
		args: [{ name: 'llll' }, { name: 'index (default: 1)' }],
	},
	{
		name: 'length',
		description:
			'The `length()` function returns the number of elements in the root level of an llll.',
		args: [{ name: 'llll' }],
	},
	{
		name: 'map',
	...
	},
	{
		name: 'perm',
		description:
			'The `perm()` function returns one or more distinct permutations of an llll, like the bach.perm object.',
		args: [
			{ name: 'llll' },
			{ name: 'maxcount (default: 0, meaning all the permutations)' },
		],
	},
	{
		name: 'primeser',
		description:
			'The `primeser()` function return sequences of primes, like the `bach.primeser` object',
		args: [
			{ name: 'min (default: 2)' },
	...
	},
	{
		...
		args: [
			{ name: 'llll' },
			{ name: 'prepend' },
			{ name: 'maxdecimals (default: 6)' },
			{ name: 'error (default: 0)' },
		],
	},
	{
		name: 'prod',
	...
	},
	{
		name: 'reduce',
		description:
			'The `reduce()` applies cumulatively a binary function to all the elements in an llll, like the `bach.reduce` object.',
	...
	},
	{
		name: 'right',
		description:
			'The `right()` function returns the right part of an llll relative to an index.',
		args: [{ name: 'llll' }, { name: 'index (default: 1)' }],
	},
	{
		name: 'rot',
	...
	},
	{
		name: 'scramble',
		description:
			'The `scramble()` function shuffles randomly the elements of an llll, like the `bach.scramble` object',
		args: [
			{ name: 'llll' },
			{ name: 'depth' },
			{ name: 'mindepth (default: 1)' },
	...
	},
	{
		name: 'slice',
		description:
			'The `slice()` function divides an llll into two sublists according to a split point.',
		args: [{ name: 'llll' }, { name: 'index (default: 1)' }],
	},
	{
		name: 'sort',
		...
		args: [
			{ name: 'llll' },
			{ name: 'function (default: null, standing for a default sorting function)' },
		],
	},
	{
		name: 'subs',
		description:
			'The `subs()` function substitutes one or more elements of a list according to their positions, like the bach.subs object.',
		args: [
			{ name: 'llll' },
			{ name: 'address (default: 1)' },
	...
	},
	{
		name: 'symdiff',
		description:
			'The `symdiff()` function returns the symmetric difference of two lllls, like the `bach.symdiff` object',
		args: [
			{ name: 'llll1' },
			{ name: 'llll2' },
			{
	...
	},
	{
		name: 'thin',
		description:
			'The `thin()` function removes the duplicates from an llll, like the `bach.thin` object.',
		args: [
			{ name: 'llll' },
			{
				name: 'function (default: null, standing for the default comparison function)',
	...
	},
	{
		name: 'trans',
		description:
			'The trans() function returns the matrix transposition of an llll, like the `bach.trans` object.',
		args: [
			{ name: 'llll' },
			{ name: 'depths (default: 1)' },
			{ name: 'iterationmode (default: 1)' },
		],
	},
	{
		name: 'union',
		description:
			'The `union()` function returns the union of two lllls, like the `bach.union` object.',
		args: [
			{ name: 'llll1' },
			{ name: 'llll2' },
			{
	...
	},
	{
		name: 'wrap',
		description:
			'The `wrap()` function wraps an llll in parentheses, thus raising its overall depth, like the `bach.wrap` object.',
...
export const nativeFunctionsCompletions = nativeFunctions.map((x) => {
	let description = `\`\`\`c\n${x.name}()\n\`\`\`\n`;
	if (x.args.length > 0) {
		description += `\nArguments:\n`;
